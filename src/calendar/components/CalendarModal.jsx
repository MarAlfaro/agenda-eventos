...
export const Calendarmodal = () => {
    ...
    //nuevo estado desde el custom hook, el anterior es el que teniamos con el useState
    const { isDateModalOpen, closeDateModal } = useUiStore();

    //estraer la función que inicia el proceso de grabación
    ...
    return(
      ...
      >
        ...
        <form className='container' onSubmit={ onSubmit} >
          ...
          <div>
            <label className='form-group mb-2'> Fecha y hora de fin </label>
            <Datepicker 
